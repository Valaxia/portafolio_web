...
function fotos_post_type() {
	...
	$labels = array(
		...
		'singular_name'         => _x( 'fotos', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'fotos', 'text_domain' ),
		'name_admin_bar'        => __( 'fotos', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Nuevo diseño', 'text_domain' ),
		'new_item'              => __( 'Nuevo diseño', 'text_domain' ),
